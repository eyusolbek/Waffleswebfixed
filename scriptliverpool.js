...
function Changebgcolor() {
    ...
    if (body.style.backgroundColor ==="rgb(0, 163, 152)") {
        ...
        body.style.backgroundColor="rgb(229, 28, 36)"; //the color of the 2023/24 second kit, make sure to double check
 ...
 function Checkifcool() {
    ...
    if (answer=== "yes") {
        result.innerText= "YNWA! You're one of the cool ones."
